...
classifications_file<-"/Volumes/External Drive/Dropbox/R/NoCoWild/CamTrapAnalysis/sampledatasmall.csv"
```
####Examine data
```{r}
...
```{r}
library(plyr)
Flattened<-plyr::join(An_flattened, Sub_flattened, by='classification_id', type='right', match='all')
```
